// Generated on 2015-05-19 using generator-ionic 0.7.3
'use strict';
...
module.exports = function (grunt) {
      ...
      sass: {
        ...
        files  : {
          '<%= yeoman.app %>/styles/app.scss': [
            '<%= yeoman.app %>/<%= yeoman.scripts %>/views/**/*.scss',
            '<%= yeoman.app %>/<%= yeoman.scripts %>/components/**/*.scss'
          ]
        }
      }
    },
  ...
  grunt.registerTask('serve', function (target) {
    ...
    grunt.task.run(['wiredep', 'injector:scripts', 'init', 'concurrent:ionic']);
  });
